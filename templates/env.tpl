...
# Backup tooling engine (mutually exclusive): barman | pgbackrest.
# pgbackrest recommended for new deployments; switching later requires a
# fresh first backup under the new tool.
BACKUP_TOOL=barman
# pgBackRest full-backup retention (only used when BACKUP_TOOL=pgbackrest)
