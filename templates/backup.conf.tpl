[backup]
;barman_lock_directory = /var/run/backup
...
;pre_backup_script = env | grep ^BACKUP
;pre_backup_retry_script = env | grep ^BACKUP
;post_backup_retry_script = env | grep ^BACKUP
;post_backup_script = env | grep ^BACKUP

; Pre/post archive hook scripts
;pre_archive_script = env | grep ^BACKUP
;pre_archive_retry_script = env | grep ^BACKUP
;post_archive_retry_script = env | grep ^BACKUP
;post_archive_script = env | grep ^BACKUP

; Pre/post delete scripts
;pre_delete_script = env | grep ^BACKUP
;pre_delete_retry_script = env | grep ^BACKUP
;post_delete_retry_script = env | grep ^BACKUP
;post_delete_script = env | grep ^BACKUP

; Pre/post wal delete scripts
;pre_wal_delete_script = env | grep ^BACKUP
;pre_wal_delete_retry_script = env | grep ^BACKUP
;post_wal_delete_retry_script = env | grep ^BACKUP
;post_wal_delete_script = env | grep ^BACKUP
